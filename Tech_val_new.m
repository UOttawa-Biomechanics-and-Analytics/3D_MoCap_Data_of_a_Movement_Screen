...
PPID_120Hz = {'38','39','446','450','451','452','457','458','461','462','527','740','742','743','744','747',...
              ...
              '1423','1426','1427','1428','1429','1430','1431','1438','1440'}; % '1424'
          
PPID_480Hz = {'46','47','50','1132','1449','1452','1455','1457','1463','1465','1466','1471','1472','1473','1474','1475','1479',...
              '1480','1484','1485','1486','1498','1499','1502','1503','1504','1505','1508','1517','1520','1525','1528','1535',...
              '1536','1539','1540','1541','1542','1543','1557','1559','1560','1561','1562','1563','1564','1571','1573','1577',...
              '1580','1581','1582','1594','1607','1608','1609','1623','1637','1654','1670','1693','1744','1808','1890','1891',...
              '1895','1900','1904'}; % '1913'
...
for p1 = 1:length(PPID_120Hz)
    ...
    load(['startstop_',PPID_120Hz{p1},'_DJ_final','.mat']); % load the start and stop point of the movement.
    ...
    plot(normalize(TRNK_O{7,1}(start_frame:stop_frame,1),100),'b');
    xlim([0 100]);
    xlabel('Normalized time [frames]');
    ylabel('Flexion / extension [degrees]')  
...
plot(normalize(TRNK_O{8,1}(start_frame:stop_frame,1),100),'b');
xlim([0 100]);
xlabel('Normalized time [frames]');
ylabel('Flexion / extension [degrees]')  
...
% 480Hz
for p2 = 1:length(PPID_480Hz)
    cd([parent_fld,'/',PPID_480Hz{p2}]);
    load(['JA_',PPID_480Hz{p2},'.mat']);
    load(['startstop_',PPID_480Hz{p2},'_DJ_final','.mat']); % load the start and stop point of the movement.
    start_frame = round(start);
    stop_frame = round(stop);
...
for p1 = 1:length(PPID_120Hz)
    cd([parent_fld,'/',PPID_120Hz{p1}]);
    load(['JA_',PPID_120Hz{p1},'.mat']);
    startstop_right = load(['startstop_',PPID_120Hz{p1},'_HDR_final','.mat']); % load the start and stop point of the movement right side.
    startstop_left = load(['startstop_',PPID_120Hz{p1},'_HDL_final','.mat']); % load the start and stop point of the movement left side.
...
cd([parent_fld,'/','1424']);
load(['JA_','1424','.mat']);
startstop_right = load(['startstop_','1424','_HDR_final','.mat']); 
startstop_left = load(['startstop_','1424','_HDL_final','.mat']); 
...
for p2 = 1:length(PPID_480Hz)
    cd([parent_fld,'/',PPID_480Hz{p2}]);
    load(['JA_',PPID_480Hz{p2},'.mat']);
    startstop_right = load(['startstop_',PPID_480Hz{p2},'_HDR_final','.mat']); % load the start and stop point of the movement right side.
    startstop_left = load(['startstop_',PPID_480Hz{p2},'_HDL_final','.mat']); % load the start and stop point of the movement left side. 
...
cd([parent_fld,'/','1913']);
load(['JA_','1913','.mat']);
startstop_right = load(['startstop_','1913','_HDR_final','.mat']); 
startstop_left = load(['startstop_','1913','_HDL_final','.mat']); 
...
for p1 = 1:length(PPID_120Hz)
    cd([parent_fld,'/',PPID_120Hz{p1}]);
    load(['JA_',PPID_120Hz{p1},'.mat']);
    startstop_right = load(['startstop_',PPID_120Hz{p1},'_LHR_final','.mat']); % load the start and stop point of the movement right side.
    startstop_left = load(['startstop_',PPID_120Hz{p1},'_LHL_final','.mat']); % load the start and stop point of the movement left side.
...
cd([parent_fld,'/','1424']);
load(['JA_','1424','.mat']);
startstop_right = load(['startstop_','1424','_LHR_final','.mat']); 
startstop_left = load(['startstop_','1424','_LHL_final','.mat']); 
...
for p2 = 1:length(PPID_480Hz)
    cd([parent_fld,'/',PPID_480Hz{p2}]);
    load(['JA_',PPID_480Hz{p2},'.mat']);
    startstop_right = load(['startstop_',PPID_480Hz{p2},'_LHR_final','.mat']); % load the start and stop point of the movement right side.
    startstop_left = load(['startstop_',PPID_480Hz{p2},'_LHL_final','.mat']); % load the start and stop point of the movement left side.
...
cd([parent_fld,'/','1913']);
load(['JA_','1913','.mat']);
startstop_right = load(['startstop_','1913','_LHR_final','.mat']);
startstop_left = load(['startstop_','1913','_LHL_final','.mat']); 
...
for p1 = 1:length(PPID_120Hz)
    cd([parent_fld,'/',PPID_120Hz{p1}]);
    load(['JA_',PPID_120Hz{p1},'.mat']);
    startstop_right = load(['startstop_',PPID_120Hz{p1},'_LR_final','.mat']); % load the start and stop point of the movement right side.
    startstop_left = load(['startstop_',PPID_120Hz{p1},'_LL_final','.mat']); % load the start and stop point of the movement left side.
...
cd([parent_fld,'/','1424']);
load(['JA_','1424','.mat']);
startstop_right = load(['startstop_','1424','_LR_final','.mat']);
startstop_left = load(['startstop_','1424','_LL_final','.mat']);
...
for p2 = 1:length(PPID_480Hz)
    cd([parent_fld,'/',PPID_480Hz{p2}]);
    load(['JA_',PPID_480Hz{p2},'.mat']);
    startstop_right = load(['startstop_',PPID_480Hz{p2},'_LR_final','.mat']); % load the start and stop point of the movement right side.
    startstop_left = load(['startstop_',PPID_480Hz{p2},'_LL_final','.mat']); % load the start and stop point of the movement left side.  
...
cd([parent_fld,'/','1913']);
load(['JA_','1913','.mat']);
startstop_right = load(['startstop_','1913','_LR_final','.mat']); 
startstop_left = load(['startstop_','1913','_LL_final','.mat']); 
...
for p1 = 1:length(PPID_120Hz)
    cd([parent_fld,'/',PPID_120Hz{p1}]);
    load(['JA_',PPID_120Hz{p1},'.mat']);
    startstop_right = load(['startstop_',PPID_120Hz{p1},'_RSR_final','.mat']); % load the start and stop point of the movement right side.
    startstop_left = load(['startstop_',PPID_120Hz{p1},'_RSL_final','.mat']); % load the start and stop point of the movement left side.
...
cd([parent_fld,'/','1424']);
load(['JA_','1424','.mat']);
startstop_right = load(['startstop_','1424','_RSR_final','.mat']); 
startstop_left = load(['startstop_','1424','_RSL_final','.mat']); 
start_frame_r = round(startstop_right.start); stop_frame_r = round(startstop_right.stop);
start_frame_l = round(startstop_left.start); stop_frame_l = round(startstop_left.stop);  
...
for p2 = 1:length(PPID_480Hz)
    cd([parent_fld,'/',PPID_480Hz{p2}]);
    load(['JA_',PPID_480Hz{p2},'.mat']);
    startstop_right = load(['startstop_',PPID_480Hz{p2},'_RSR_final','.mat']); % load the start and stop point of the movement right side.
    startstop_left = load(['startstop_',PPID_480Hz{p2},'_RSL_final','.mat']); % load the start and stop point of the movement left side.
...
for p1 = 1:length(PPID_120Hz)
    cd([parent_fld,'/',PPID_120Hz{p1}]);
    load(['JA_',PPID_120Hz{p1},'.mat']);
    startstop_right = load(['startstop_',PPID_120Hz{p1},'_SDR_final','.mat']); % load the start and stop point of the movement right side.
    startstop_left = load(['startstop_',PPID_120Hz{p1},'_SDL_final','.mat']); % load the start and stop point of the movement left side.
...
cd([parent_fld,'/','1424']);
load(['JA_','1424','.mat']);
startstop_right = load(['startstop_','1424','_SDR_final','.mat']);
startstop_left = load(['startstop_','1424','_SDL_final','.mat']); 
...
for p2 = 1:length(PPID_480Hz)
    cd([parent_fld,'/',PPID_480Hz{p2}]);
    load(['JA_',PPID_480Hz{p2},'.mat']);
    startstop_right = load(['startstop_',PPID_480Hz{p2},'_SDR_final','.mat']); % load the start and stop point of the movement right side.
    startstop_left = load(['startstop_',PPID_480Hz{p2},'_SDL_final','.mat']); % load the start and stop point of the movement left side.
...
cd([parent_fld,'/','1913']);
load(['JA_','1913','.mat']);
startstop_right = load(['startstop_','1913','_SDR_final','.mat']); % load the start and stop point of the movement right side.
startstop_left = load(['startstop_','1913','_SDL_final','.mat']); % load the start and stop point of the movement left side.
...
for p1 = 1:length(PPID_120Hz)
    cd([parent_fld,'/',PPID_120Hz{p1}]);
    load(['JA_',PPID_120Hz{p1},'.mat']);
    startstop_right = load(['startstop_',PPID_120Hz{p1},'_TBR_final','.mat']); % load the start and stop point of the movement right side.
    startstop_left = load(['startstop_',PPID_120Hz{p1},'_TBL_final','.mat']);  % load the start and stop point of the movement left side.
...
cd([parent_fld,'/','1424']);
load(['JA_','1424','.mat']);
startstop_right = load(['startstop_','1424','_TBR_final','.mat']);
startstop_left = load(['startstop_','1424','_TBL_final','.mat']);  
...
for p2 = 1:length(PPID_480Hz)
    cd([parent_fld,'/',PPID_480Hz{p2}]);
    load(['JA_',PPID_480Hz{p2},'.mat']);
    startstop_right = load(['startstop_',PPID_480Hz{p2},'_TBR_final','.mat']); % load the start and stop point of the movement right side.
    startstop_left = load(['startstop_',PPID_480Hz{p2},'_TBL_final','.mat']); % load the start and stop point of the movement left side.
...
cd([parent_fld,'/','1913']);
load(['JA_','1913','.mat']);
startstop_right = load(['startstop_','1913','_TBR_final','.mat']); 
startstop_left = load(['startstop_','1913','_TBL_final','.mat']); 
